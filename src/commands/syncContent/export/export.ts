...
import { exportAsync, getDefaultLogger, storeAsync } from "@kontent-ai-consulting/migration-toolkit";
...
const commandName = "save-content";
      ...
      builder: yargs =>
        yargs
          ...
          .option("itemsFilename", {
            ...
            demandOption: "You need to provide filename for items.",
          })
          .option("assetsFilename", {
            type: "string",
            describe: "Filename where assets should be stored.",
            demandOption: "You need to provide filename for assets",
          })
          .option("last", {
            type: "number",
...
export type GenerateSyncContentParams =
  & Readonly<{
...
export const generateSyncContent = async (params: GenerateSyncContentParams) => {
