...
const cleanEntityDefinitions = [
  ...
  languagesEntity,
  webhooksEntity,
] as const satisfies ReadonlyArray<AnyEntityCleanDefinition>;
...
export const cleanEnvironmentInternal = async (
  ...
  logInfo(params, "standard", `Cleaning entities from ${chalk.blue(params.environmentId)}.`);
  ...
  logInfo(params, "standard", chalk.green("Environment clean finished successfully."));
};
