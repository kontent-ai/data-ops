...
const RichTextImageConditionSchema = z.enum(
  RichTextImageConditionTuple satisfies IsFullEnum<
    IsSubset<
      (typeof RichTextImageConditionTuple)[number],
      ContentTypeElements.RichTextImageCondition
    >,
    IsSubset<
      ContentTypeElements.RichTextImageCondition,
      (typeof RichTextImageConditionTuple)[number]
...
const RichTextAllowedTextBlockSchema = z.enum(
  RichTextAllowedTextBlock satisfies IsFullEnum<
    IsSubset<
      (typeof RichTextAllowedTextBlock)[number],
      ContentTypeElements.RichTextAllowedTextBlock
    >,
    IsSubset<
      ContentTypeElements.RichTextAllowedTextBlock,
      (typeof RichTextAllowedTextBlock)[number]
...
const RichTextAllowedFormattingSchema = z.enum(
  RichTextAllowedFormatting satisfies IsFullEnum<
    IsSubset<
      (typeof RichTextAllowedFormatting)[number],
      ContentTypeElements.RichTextAllowedFormatting
    >,
    IsSubset<
      ContentTypeElements.RichTextAllowedFormatting,
      (typeof RichTextAllowedFormatting)[number]
...
export const TypeElementWithGroupSchemasUnion = z.discriminatedUnion("type", [
  ...TypeElementSchemasWithGroups,
]);
