...
type Zip<T1 extends ReadonlyArray<any>, T2 extends ReadonlyArray<any>> = true extends
  IsEmptyTuple<T1> | IsEmptyTuple<T2> ? readonly []
  : [IsNonEmptyTuple<T1>, IsNonEmptyTuple<T2>] extends [true, true] ? ZipTuples<T1, T2>
  : ZipArrays<T1, T2>;
 ...
 */
type ZipArrays<T1 extends ReadonlyArray<any>, T2 extends ReadonlyArray<any>> = ReadonlyArray<
...
type ZipTuples<
  ...
  Accum extends ReadonlyArray<readonly [any, any]> = readonly [],
> = [T1, T2] extends [
  readonly [infer First1, ...infer Rest1 extends ReadonlyArray<any>],
  readonly [infer First2, ...infer Rest2 extends ReadonlyArray<any>],
